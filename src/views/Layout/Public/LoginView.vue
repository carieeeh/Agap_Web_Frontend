...
<template>
  <div class="h-screen w-full">
    <div class="grid grid-cols-5 items-center justify-center h-screen w-full">
      <div class="flex justify-center col-span-2 relative">
        <img
          class="h-20 absolute top-52 left-96"
          src="/assets/images/gif/flood.gif"
          alt=""
        />
        <img
          class="h-20 absolute bottom-72 left-36"
          src="/assets/images/gif/humanitarian-help.gif"
          alt=""
        />
        <img
          class="h-20 absolute top-48 left-1/3"
          src="/assets/images/gif/fire_building.gif"
          alt=""
        />
        <img
          class="h-20 absolute bottom-40 left-10"
          src="/assets/images/gif/first-aid-kit.gif"
          alt=""
        />
        <img
          class="h-20 absolute bottom-48 left-64"
          src="/assets/images/gif/security-guard.gif"
          alt=""
        />
        <img
          class="h-20 absolute bottom-56 left-96"
          src="/assets/images/gif/charity.gif"
          alt=""
        />
        <img
          class="h-20 absolute bottom-32 right-10"
          src="/assets/images/gif/ambulance.gif"
          alt=""
        />
        <img
          class="h-20 absolute top-56 left-10"
          src="/assets/images/gif/earthquake_colored.gif"
          alt=""
        />
        <img class="h-44" src="/assets/images/red_no_bg_logo.png" alt="" />
      </div>
      <div
        class="col-span-3 flex items-center justify-center h-screen w-full bg-gray-200"
      >
