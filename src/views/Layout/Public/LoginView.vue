  ...
  <div class="h-screen w-full">
    <div class="grid grid-cols-5 items-center justify-center h-screen w-full">
      <div class="flex justify-center col-span-2 relative">
        <img class="h-20 absolute top-52 left-96" src="/assets/images/gif/flood.gif" alt="">
        <img class="h-20 absolute bottom-72 left-36" src="/assets/images/gif/humanitarian-help.gif" alt="">
        <img class="h-20 absolute top-48 left-1/3" src="/assets/images/gif/fire_building.gif" alt="">
