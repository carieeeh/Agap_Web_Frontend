  ...
  <div>
    <div class="relative">
      ...
      <div class="grid grid-cols-1 items-end gap-4 lg:grid-cols-12">
        ...
        <button @click="useSendPushNotification()" class="lg:col-span-2 md:truncate bg-green-300 rounded-md h-8 w-32 flex items-center justify-center gap-3 hover:bg-green-400 lg:w-full">
