...
function select(item, index) {
    emits('select', { item: item, index: index });
        ...
        <Listbox as="div" v-model="selected">
            <div class="relative">
                ...
                <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                    ...
                    <ListboxOptions
                        class="absolute z-10 mt-1 h-32 overflow-y-auto w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
